UPDATE shows SET title = "How I Met Your Mother" WHERE title LIKE "How i met your mother";
 ...
 UPDATE shows SET title = "Parks and Recrea1on" WHERE title LIKE "Parks and Recrea1on";
 UPDATE shows SET title = "Sherlock" WHERE title LIKE "Adventure Time";
 UPDATE shows SET title = "Squid Game" WHERE title LIKE "Sherlock";
 UPDATE shows SET title = "The Bachelorede" WHERE title LIKE "The Bachelorede";
 ...
 UPDATE shows SET title = "Brooklyn Nine-Nine" WHERE title LIKE "Brooklyn%";
  ...
  UPDATE shows SET title = "Grey’s Anatomy" WHERE title LIKE "Grey%";
   ...
   UPDATE shows SET title = "It’s Always Sunny in Philadelphia" WHERE title LIKE "%Philadelphia";
    ...
    UPDATE shows SET title = "Parks and Recrea1on" WHERE title LIKE "Parks and Rec";
